    ...
    var P = function(h) {
        ...
        function P(a) {
            var b = m.defaults.oLanguage,
                c = a.sZeroRecords;
            !a.sEmptyTable && (c && "No hay datos disponibles en la tabla" === b.sEmptyTable) && E(a, a, "sZeroRecords", "sEmptyTable");
        ...
        function x(a, b, c, e) {
            ...
            if (c === k) return a.iDrawError != d && null === j && (I(a, 0, "Parámetro desconocido solicitada " + ("function" == typeof f.mData ? "{function}" : "'" + f.mData + "'") + " for row " + b, 4), a.iDrawError = d), j;
            if ((c === g || null === c) &&
                null !== j) c = j;
        ...
        function ob(a) {
            var b = a.oClasses,
                ...
                d = a.oPreviousSearch,
                f = a.aanFeatures,
                g = '<input type="search"  maxlength="20" class="' + b.sFilterInput + '"/>',
                j = e.sSearch,
                    ...
                    for (j = n.length; g < j; g++) {
                        ...
                        if (r.nTable == this || r.nTHead.parentNode == this || r.nTFoot && r.nTFoot.parentNode == this) {
                            ...
                            if (d.bDestroy !== k ? d.bDestroy : l.bDestroy) {
                                ...
                                I(r, 0, "No se puede reinicializar DataTable", 3);
                                return
                            }
                        }
        ...
        m.defaults = {
            ...
            oLanguage: {
                ...
                sInfoFiltered: "(Filtrada de _MAX_ total Entradas)",
                sInfoPostFix: "",
                sDecimal: "",
                sThousands: ",",
        ...
        h.extend(m.ext.classes, {
            ...
            sFilter: "dataTables_filter escon1",
            sInfo: "dataTables_info",
            sPaging: "dataTables_paginate paging_",
            sLength: "dataTables_length escon1",
