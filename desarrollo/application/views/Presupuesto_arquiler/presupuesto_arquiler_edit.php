          ...
          <div class="roww">
             <div  style="height: 300px;  "> 
               ...
               <input type="hidden" name="fecha_expedicion" id="fecha_expedicion" value="<?php echo date("Y-m-d");?>">
                                                              {formulario}
                            <input type="hidden" name="controlbutton" value="{idArquiler}">
                           <!-- cabecera cliente -->
                             <div class="col-xs-8">
                                ...
                                <tr>
                                  <td colspan="" colspan="" headers="" height="10" width="">
                                     ...
                                     <div class="col-xs-4">
                                          ...
                                          <input required  maxlength="20"  type='text' id='autocomplete busqueda_cliente' name="Nombres" class="autocomplete form-control input-sm busqueda_cliente" value="{Nombres}" placeholder="Nombre del Cliente "  title="Seleciona "/>
                                    ...
                                    <label for="" class="col-xs-2 ">C.I/R.U.C</label>
                                     <div class="col-xs-4">
                                          <span class ="cli text-danger"></span>
                                          <input required  type="number" step="any" id='autocomplete busqueda_cliente2' name="ci_ruc" class="autocomplete form-control input-sm busqueda_cliente2" value="{ci_ruc}" placeholder="Cedula-R.U.C"  title="Seleciona "/>
                                          <input  id="idCliente2" name="idCliente2" class="form-control" placeholder="idCliente2" value="{idCliente}" type="hidden"  />
                                    </div>
                                  </td>
                                </tr>
                                    <tr>
                                   ...
                                   <tr>
                                      <td style="text-align:left">
                                                                 ...
                                                                 <div class="col-xs-4">
                                                                   <textarea id="Direccion_evento" maxlength="100" name="Direccion_evento" class="form-control input-sm" placeholder="Direccion Evento" rows="1" required="required">{Direccion_evento}</textarea>
                                                                </div>
                                                                <label for="" class="col-xs-2 "></label>
                                                                <label for="" class="col-xs-4 "><a class="btn btn-block btn-social btn-sm btn-default" onclick="mapa({Geo_posicion_idGeo_posicion});">
                                      <i class="fa fa-map-marker"></i> Direccion Mapa</a> </label>
                                        </td>
                                     </tr>
                                </table>
                            </div>
      ...
      <div class="modal fade" id="modal_form_alquiler">
        <div class="modal-dialog">
         ...
         <div class="modal-footer">
            ...
            <button type="submit" id="btnSave" onclick="add_alquiler({idArquiler})" class="btn btn-sm btn-success">
