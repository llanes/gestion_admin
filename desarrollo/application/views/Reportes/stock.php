...
<section class="content" >
 ...
 <form role="form" id="al_pre" name="al_pre"  method="POST" target="myIframe" action="<?= site_url('index.php/Reportes/generar_stock'); ?>">
  <table class="table table-condensed" >
    ...
    <td colspan="">
               <label for="" class="col-xs-1 ">Rango</label>
                 <div class="col-xs-3   ">
                          <select name="rango_stock" id="rango_stock" class="form-control input-sm" >
                 ...
                 <label for="" class="col-xs-1 ">Stock</label>
                 <div class="col-xs-3   ">
                          <select name="limite_stock" id="limite_stock" class="form-control input-sm" >
                                <option class="" value="5">Todos</option>
                            <option class="" value="10">Menores de 10</option>
                              <option class="" value="50">Menores de 50</option>
                                <option class="" value="100">Menor de 100</option>
                          </select>
                </div>
