...
<section class="content" >
 ...
 <form role="form" id="al_pre" name="al_pre"  method="POST" target="myIframe" action="<?= site_url('index.php/Reportes/generar_cliente'); ?>">
  <table class="table table-condensed" >
    ...
    <td colspan="">
               <label for="" class="col-xs-2 ">Rango</label>
                 <div class="col-xs-4   ">
                          <select name="rango_cliente" id="rango_cliente" class="form-control input-sm" >
