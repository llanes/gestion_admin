...
class Cliente extends CI_Controller {
		...
		public function ajax_list()
	{
		...
		foreach ($list as $cliente) {
			...
			<a class="btn btn-success btn-sm" href="javascript:void()" title="Edit" onclick="edit_person('."'".$cliente->idCliente."'".')">
			<i class="fa fa-pencil-square"></i></a>
			<a class="btn btn-sm btn-danger" href="javascript:void()" title="Hapus" onclick="delete_person('."'".$cliente->idCliente."'".')">
